    ...
    <div className="relative z-10 pb-10">
      ...
      >
        ...
        <div className="text-center mt-24 text-gray-500">
          ...
          {/* Subtle link to secret admin page */}
          <button
            onClick={() => {
              const checkPass = prompt("Enter Administrator Access Passcode:");
              if (checkPass === 'jeeva' || checkPass === 'jeevaadmin') {
                setViewMode('dashboard');
              } else if (checkPass) {
                alert("Access Denied.");
              }
            }}
            className="mt-6 hover:text-pink-400 transition-colors text-xs font-semibold uppercase tracking-[3px] opacity-40 hover:opacity-100"
          >
